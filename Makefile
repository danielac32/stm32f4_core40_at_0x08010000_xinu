...
SRCPATH      = $(sort $(dir $(SOURCES) $(SRCLIB) $(SRCGPIO) $(SRCUSB) $(SRCKERNEL) $(SRCSPI) $(SRCBERRY) $(SRCSHELL) $(SRCFAT32) $(SRCSDSPI) $(SRCW25Q) ))
vpath %.c $(SRCPATH)
vpath %.S $(SRCPATH)
...
$(DOUT).elf : $(OBJDIR) $(LIBOBJ) $(SHELLOBJ) $(BERRYOBJ) $(GPIOOBJ) $(USBOBJ) $(kERNELOBJ) $(SPIOBJ) $(SDSPIOBJ) $(FAT32OBJ) $(W25QOBJ) $(OBJECTS) 
	@echo building $@
	@$(LD) $(CFLAGS2) $(LDFLAGS) -Wl,--script='$(LDSCRIPT)' $(LIBOBJ) $(GPIOOBJ) $(BERRYOBJ) $(SHELLOBJ) $(USBOBJ) $(FAT32OBJ) $(SDSPIOBJ) $(W25QOBJ) $(SPIOBJ) $(kERNELOBJ) $(OBJECTS) -o $@
